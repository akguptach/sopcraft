		...
		<section class="we-make-sec">
		  <div class="container">
		    <div class="row align-items-center">
		      ...
		      <div class="col-lg-6">
		        <div class="row sh-list gy-4 mt-md-4 mt-lg-0">         
	...
	<section class="mb-5 mt-5">
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-md-6">
                            <picture>
                                <img src="{{ asset('images/Research_paper_writing_service.jpg') }}" class="card-img-top" alt="Essay Help" title="Essay Hel"
                                    loading="lazy" width="374" height="374">
                            </picture>
                    </div>
                    <div class="col-md-6">
                        <div class="we-work-content">
                            <h3 class="text-header">Research paper writing service</h3>
                            <p>An online paper writing service has a team of expert academic paper writers who share ideas and information for a perfect research thesis that helps in completing your opinion on the topic. When you seek help to write research papers you can choose us, we will assure you the best unique content for your coursework.</p>
        
                            <p>A thesis is a type of research paper based on your original research. It is usually submitted as the final step of a master's program or a capstone to a bachelor's degree. Writing a thesis can be a daunting experience. Other than a dissertation, it is one of the longest pieces of writing students typically complete.</p>
