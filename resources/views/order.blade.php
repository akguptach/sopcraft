...
@section('content')
    ...
    <section class="order-sec">
        <div class="container">
            ...
            <form class="order-form" id="order_form" name="order_form" enctype="multipart/form-data" method="POST" enctype="multipart/form-data"
                action="#">
                @csrf
                <div class="row">
                    <div class="col-md-8">
                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input name="subject_name" id="subject_name" type="text"
                                                ...
                                                value="@if (app('request')->input('subject_name')) {{ app('request')->input('subject_name') }} @endif" required />
                                        </div>
                                        <span class="error-message" id="subject_name-error" style="display: none; color:red;">Please enter subject</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <span class="error-message" id="task_topic-error" style="display: none; color:red;">Please enter task topic</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select select2" id="task_type_id" name="task_type_id"
                                            ...
                                            @if (!empty($task_types))
                                                : @foreach ($task_types as $task_type)
                                                    <option value="<?= $task_type['id'] ?>" @if (app('request')->input('task_type_id') == $task_type['id'])
                                                        {{ 'selected' }}
                                    ...
                                    <span class="error-message" id="task_type_id-error" style="display: none; color:red;">Please select task type</span>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select select2" id="studylabel_id" name="studylabel_id"
                                            ...
                                            @if (!empty($levels))
                                                ...
                                                @foreach ($levels as $level)
                                                    <option value="<?= $level['id'] ?>" @if (app('request')->input('studylabel_id') == $level['id'])
                                                        {{ 'selected' }}
                                    ...
                                    <span class="error-message" id="studylabel_id-error" style="display: none; color:red;">Please select the level of study</span>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <span class="error-message" id="no_of_words-error" style="display: none; color:red;">Please choose no of words</span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="title-task-box">
                                        ...
                                        <hr class="my-0" />
                                        <span class="error-message" id="title-error" style="display: none; color:red;">Please enter title for your task/project</span>
                                        <textarea class="form-control" id="task" name="task" rows="3"
                                            placeholder="Tell us more about your task.."></textarea>
                                            <span class="error-message" id="task-error" style="display: none; color:red;">Please enter more about your task</span>
                                ...
                                <span class="error-message" id="fileuploadrerror" style="display: none; color:red;display: none;" >Please select file</span>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <span class="error-message" id="delivery_date-error" style="display: none; color:red;">Please select date</span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="title-task-box ta-task">
                                        <textarea class="form-control" id="task1" rows="3" placeholder="Write your answer here"
                                            name="tasktitle[]"></textarea>
                                        <div class="text-end">
                                            <div class="file-upload-box">
                                                <label for="taskFile" class="form-label">Attach files</label>
                                                <input class="form-control" id="taskFile" type="file"
                                    ...
                                    <span class="error-message" id="tasktitle-error" style="display: none; color:red;">Please enter subject</span>
                                    <span class="error-message" id="taskFile-error" style="display: none; color:red;">Please enter subject</span>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="sticky-top">
                            <div class="order-summary os-theme">
                                ...
                                <p class="text-center text-tcnp">By proceeding to checkout you accept our <a
                                        href="#" class="link">Terms and Conditions</a> and <a href="#"
    ...
    <div class="modal fade" id="fileuploadModal" tabindex="-1" aria-labelledby="fileuploadModalLabel"
        ...
        <div class="modal-dialog modal-sm">
            <form class="file-upload-form" id="file_upload_form" enctype="multipart/form-data" action="#" enctype="multipart/form-data">
